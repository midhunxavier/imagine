...
export default function EquationFigure({
  ...
  return (
    <Figure width={width} height={height} background={background} title="Equation">
      <EditableText propKey="title" x={40} y={54} fontSize={18} fontWeight={800} fill={theme.colors.text}>
        {title}
      </EditableText>
      <EditableText propKey="subtitle" x={40} y={84} fontSize={13} fill={theme.colors.subtleText}>
        {subtitle}
      </EditableText>
